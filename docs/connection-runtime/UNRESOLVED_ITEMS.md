...
1. Migration 0082 is applied and verified. The independently reviewed canonical onboarding-run creation must be committed and deployed before retrying the existing pending read-only OAuth launch.
