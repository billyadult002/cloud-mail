const en = {
    ...
    starred: 'Starred',
    settings: 'Settings',
    domainActivation: 'Domain Activation',
    domainActivationTitle: 'Choose the workspace authority',
    domainActivationIntro: 'Validate the administrator and Workspace 1 before any DNS ownership action can begin.',
    domainActivationActorTitle: 'Authenticated administrator',
    domainActivationActorVerified: 'The server accepted this administrator for workspace discovery.',
    domainActivationActorPending: 'Refresh from the server to verify the current administrator.',
    domainActivationDiscover: 'Refresh actor & workspaces',
    domainActivationWorkspaceTitle: 'Select Workspace 1',
    domainActivationWorkspaceHelp: 'Selection is explicit. Validation checks capability only and does not change DNS or domain authority.',
    domainActivationNoWorkspace: 'No eligible workspace was returned.',
    domainActivationUnknownRole: 'Unknown role',
    domainActivationEligible: 'Eligible',
    domainActivationReadOnly: 'Read only',
    domainActivationConfirmWorkspaceOne: 'I am explicitly selecting Workspace 1 for NEXORA domain activation.',
    domainActivationValidate: 'Validate Workspace 1 capability',
    domainActivationValidated: 'Capability validated',
    domainActivationDnsTitle: 'DNS ownership',
    domainActivationDnsLocked: 'Challenge issuance and TXT publication remain locked until separately approved.',
    domainActivationDnsPending: 'A pending TXT challenge is held in memory for this page only.',
    domainActivationConfirmChallenge: 'I separately approve issuing one DNS ownership challenge.',
    domainActivationCreateChallenge: 'Issue DNS challenge',
    domainActivationSensitiveTxt: 'Sensitive activation value. Do not include it in logs, screenshots, or reports.',
    domainActivationRevalidateChallenge: 'Authorization expired. Revalidate the same workspace to verify this existing challenge; no new challenge will be created.',
    domainActivationConfirmVerify: 'DNS propagation is confirmed and I separately approve verification.',
    domainActivationVerify: 'Verify DNS ownership',
    domainActivationAuthorityTitle: 'Domain Authority',
    domainActivationAuthorityLocked: 'Verification and authority bootstrap remain locked until separately approved.',
    domainActivationAuthorityReady: 'DNS ownership is verified. Bootstrap still requires separate confirmation.',
    domainActivationConfirmBootstrap: 'I separately approve creating the verified Domain Authority.',
    domainActivationBootstrap: 'Bootstrap Domain Authority',
    domainActivationAuthorityComplete: 'Domain Authority established',
    domainActivationSeparateApproval: 'Separate approval required',
    domainActivationCapabilityValidated: 'Workspace 1 capability validated',
    domainActivationNotStarted: 'DNS ownership has not started.',
    analytics: 'Analytics',
    allUsers: 'All Users',
    allMail: 'All Mail',
    permissions: 'Role',
