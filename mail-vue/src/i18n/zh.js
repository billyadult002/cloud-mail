const zh = {
    ...
    starred: '星标邮件',
    settings: '个人设置',
    domainActivation: '域名激活',
    domainActivationTitle: '选择工作区权威',
    domainActivationIntro: '在开始任何 DNS 所有权操作前，先验证管理员与 Workspace 1。',
    domainActivationActorTitle: '已认证管理员',
    domainActivationActorVerified: '服务器已接受此管理员进行工作区发现。',
    domainActivationActorPending: '从服务器刷新以验证当前管理员。',
    domainActivationDiscover: '刷新管理员与工作区',
    domainActivationWorkspaceTitle: '选择 Workspace 1',
    domainActivationWorkspaceHelp: '必须显式选择。能力验证不会修改 DNS 或域名权威。',
    domainActivationNoWorkspace: '服务器未返回可用工作区。',
    domainActivationUnknownRole: '未知角色',
    domainActivationEligible: '可验证',
    domainActivationReadOnly: '只读',
    domainActivationConfirmWorkspaceOne: '我明确选择 Workspace 1 用于 NEXORA 域名激活。',
    domainActivationValidate: '验证 Workspace 1 能力',
    domainActivationValidated: '能力已验证',
    domainActivationDnsTitle: 'DNS 所有权',
    domainActivationDnsLocked: 'Challenge 签发与 TXT 发布仍被锁定，需单独批准。',
    domainActivationDnsPending: '待处理 TXT challenge 仅保存在当前页面内存中。',
    domainActivationConfirmChallenge: '我单独批准签发一个 DNS 所有权 challenge。',
    domainActivationCreateChallenge: '签发 DNS challenge',
    domainActivationSensitiveTxt: '敏感激活值。不得写入日志、截图或报告。',
    domainActivationRevalidateChallenge: '授权已过期。请重新验证同一 Workspace 后继续验证现有挑战；系统不会创建新挑战。',
    domainActivationConfirmVerify: 'DNS 已传播，我单独批准执行验证。',
    domainActivationVerify: '验证 DNS 所有权',
    domainActivationAuthorityTitle: '域名权威',
    domainActivationAuthorityLocked: '验证与权威 Bootstrap 仍被锁定，需单独批准。',
    domainActivationAuthorityReady: 'DNS 所有权已验证。Bootstrap 仍需单独确认。',
    domainActivationConfirmBootstrap: '我单独批准创建已验证的域名权威。',
    domainActivationBootstrap: 'Bootstrap 域名权威',
    domainActivationAuthorityComplete: '域名权威已建立',
    domainActivationSeparateApproval: '需要单独批准',
    domainActivationCapabilityValidated: 'Workspace 1 能力已验证',
    domainActivationNotStarted: 'DNS 所有权尚未开始。',
    analytics: '分析页',
    allUsers: '用户列表',
    allMail: '全部邮件',
    permissions: '权限控制',
