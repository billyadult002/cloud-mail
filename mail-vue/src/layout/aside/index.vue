  ...
  <el-scrollbar class="scroll">
    <div>
      ...
      <el-menu :collapse="false" text-color="#fff" active-text-color="#fff" style="margin-top: 10px">
        ...
        <el-menu-item @click="router.push({name: 'domain-activation'})" index="domain-activation"
                      :class="route.meta.name === 'domain-activation' ? 'choose-item' : ''">
          <Icon icon="solar:shield-keyhole-outline" width="20" height="20" />
          <span class="menu-name" style="margin-left: 21px">{{$t('domainActivation')}}</span>
        </el-menu-item>
