const en = {
    ...
    addGmail: 'Add Gmail',
    addGmailDetail: 'Connect Gmail with Google. CloudMail will use the same Google authorization for Gmail and Gemini.',
    addGmailUnifiedAuth: 'You will continue from CloudMail to Google consent, then return to CloudMail automatically.',
    cloudMailAddress: 'CloudMail Address',
