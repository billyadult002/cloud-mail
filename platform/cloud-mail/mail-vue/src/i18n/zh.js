const zh = {
    ...
    addAccount: '添加邮箱',
    addGmail: '添加 Gmail',
    addGmailDetail: '使用 Google 连接 Gmail。CloudMail 会用同一次 Google 授权启用 Gmail 和 Gemini。',
    addGmailUnifiedAuth: '你会先从 CloudMail 进入 Google 授权，同意后自动回到 CloudMail。',
    cloudMailAddress: 'CloudMail 邮箱',
