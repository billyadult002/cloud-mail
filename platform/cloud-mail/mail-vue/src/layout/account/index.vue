<template>
  <div class="account-box">
    ...
    <el-dialog v-model="showAdd" :title="$t('addAccount')">
      <div class="container">
        <div class="gmail-oauth-entry">
          <div class="gmail-oauth-copy">
            <div class="gmail-oauth-title">{{ $t('addGmail') }}</div>
            <div class="gmail-oauth-detail">{{ $t('addGmailDetail') }}</div>
          </div>
          <el-button class="gmail-oauth-button" type="primary" plain @click="openAddGmail">
            {{ $t('continueWithGoogle') }}
          </el-button>
        </div>
        <el-divider>{{ $t('cloudMailAddress') }}</el-divider>
...
function openAddGmail() {
  showAdd.value = false
  router.push({name: 'add-gmail'})
}
