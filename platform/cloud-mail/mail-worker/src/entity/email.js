...
export const email = sqliteTable('email', {
	...
	accountDomain: text('account_domain').default('').notNull(),
	threadId: text('thread_id').default('').notNull(),
	externalMessageId: text('external_message_id').default('').notNull(),
	folderKey: text('folder_key').default('inbox').notNull(),
